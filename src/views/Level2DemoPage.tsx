...
export const Level2DemoPage: React.FC = () => {
  ...
  return (
    <Layout showFooter={true}>
      <div className="min-h-dvh relative overflow-hidden text-slate-100 selection:bg-civic-blue selection:text-white pb-16">
        {/* Background Glows */}
        ...
        <div className="border-b border-shield-glass/30 bg-shield-dark/50 backdrop-blur-xl relative z-10">
          <div className="max-w-4xl mx-auto px-6 py-3.5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[0.65rem] sm:text-xs font-bold px-3 py-1 rounded-full bg-civic-trust/15 text-civic-trust border border-civic-trust/30 uppercase tracking-wider">
